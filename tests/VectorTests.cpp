...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenCollectionWithTwoElements_WhenPostIncrementing_ThenPrePositionIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
  ...
  BOOST_CHECK_EQUAL(*(collection.begin()++), 1);
}
...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenIterator_WhenIncrementingToEndAndDecrementingBack_ThenProperValueIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAssigningToSelf_NothingHappens,
                              T,
                              TestedTypes)
{
...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenMoveAssigningToSelf_NothingHappens,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1, 2, 3, 4 };
...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAssigningToOther_ThenSizeIsProper,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection = { 1, 2, 3, 4, 5 };
  LinearCollection<T> other = { 100, 200, 300, 400 };

  other = collection;

  BOOST_CHECK_EQUAL(other.getSize(), 5);
}

// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAssigningToOtherSmaller_ThenAllElementsAreCopied,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection = { 1, 2, 3, 4, 5 };
  ...
  thenCollectionContainsValues(other, { 1, 2, 3, 4, 5});
  BOOST_CHECK_EQUAL(other.getSize(), 5);
}

// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenAssigningToOtherBigger_ThenAllElementsAreCopied,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection = { 1, 2, 3 };
  LinearCollection<T> other = { 100, 200, 300, 400 };

  other = collection;

  thenCollectionContainsValues(other, { 1, 2, 3 });
  BOOST_CHECK_EQUAL(other.getSize(), 3);
}
...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenMoveAssigningToOtherSmaller_ThenAllElementsAreMoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1, 2, 3, 4, 5 };
  LinearCollection<T> other = { 100, 200, 300, 400 };
...
// MY TEST
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenMoveAssigningToOtherBigger_ThenAllElementsAreMoved,
                              T,
                              TestedTypes)
{
